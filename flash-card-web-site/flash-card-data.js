...
// Generated on: 2025-12-20T12:10:57.107Z
// Total cards: 790 (512 Q&A, 216 sections, 62 concepts)
...
window.FLASH_CARD_DATA = [
  ...
  {
    "question": "Example in a Trading Context",
    "answer": [
      {
        "type": "code",
        "language": "csharp",
  ...
  },
  {
    ...
    "answer": [
      ...
      {
        "type": "text",
        "content": "1. 500 concurrent requests come in"
      },
      {
        "type": "text",
        "content": "2. All 500 grab a thread and block"
      },
      {
        "type": "text",
        "content": "3. Thread pool exhausted"
      },
      {
        "type": "text",
        "content": "4. New requests queue up or timeout"
      },
      {
        "type": "text",
        "content": "5. System dies under load"
      }
    ],
    "category": "notes",
    "topic": "Use-Cases",
  ...
  {
    "question": "✅ Good: Async All The Way",
    "answer": [
      {
        "type": "code",
        "language": "csharp",
      ...
      {
        "type": "text",
        "content": "1. 5,000 concurrent requests come in"
      },
      {
        "type": "text",
        "content": "2. Each starts on a thread, hits await, releases the thread"
      },
      {
        "type": "text",
        "content": "3. Threads return to pool, handle more requests"
      },
      {
        "type": "text",
        "content": "4. When I/O completes, continuation runs on available thread"
      },
      {
        "type": "text",
        "content": "5. Same thread pool handles 10x more throughput"
      },
      {
        "type": "text",
        "content": "“Async/await allows us to release threads while waiting for I/O, so the same threads can serve many more requests.”"
      },
      {
        "type": "text",
        "content": "What async actually means (important explanation)"
      },
      {
        "type": "text",
        "content": "When you await an I/O operation:"
      },
      {
        "type": "list",
        "items": [
      ...
      {
        "type": "text",
        "content": "This is not multithreading, it’s non-blocking I/O."
      },
      {
        "type": "text",
        "content": "“With blocking code, throughput is limited by thread count. With async code, throughput is limited by I/O capacity.”. “Async/await doesn’t make code faster, it makes the system scale by freeing threads during I/O.”"
      },
      {
        "type": "text",
        "content": "| Model    | Threads | Avg I/O | Max Throughput |"
      },
      {
        "type": "text",
        "content": "| -------- | ------- | ------- | -------------- |"
      ...
      {
        "type": "text",
        "content": "| Blocking | 200     | 50ms    | ~4,000 req/s   |"
      },
      {
        "type": "text",
        "content": "| Async    | 200     | 50ms    | 50,000+ req/s  |"
      },
      {
        "type": "text",
  ...
  {
    "question": "✅ Good: HttpClientFactory",
    "answer": [
      {
        "type": "code",
        "language": "csharp",
      ...
      {
        "type": "text",
        "content": "“Without HttpClientFactory, each request creates new sockets, which quickly exhaust OS resources. HttpClientFactory centralizes connection pooling, respects DNS changes, and enforces connection limits, which is essential for high-throughput systems.”"
      },
      {
        "type": "text",
        "content": "| Topic              | New HttpClient | HttpClientFactory |"
      },
      {
        "type": "text",
        "content": "| ------------------ | -------------- | ----------------- |"
      ...
      {
        "type": "text",
        "content": "| Socket reuse       | ❌ No           | ✅ Yes             |"
      },
      {
        "type": "text",
        "content": "| DNS refresh        | ❌ No           | ✅ Yes             |"
      },
      {
        "type": "text",
        "content": "| Connection pooling | ❌ No           | ✅ Yes             |"
      },
      {
        "type": "text",
        "content": "| Under load         | 💥 Fails       | 🚀 Stable         |"
      },
      {
        "type": "text",
        "content": "| Recommended        | ❌ Never        | ✅ Always          |"
      },
      {
        "type": "text",
  ...
  {
    "question": "✅ Correct Patterns",
    "answer": [
      {
        "type": "text",
        "content": "If a method is async, everything below it must be async."
      },
      {
        "type": "code",
        "language": "csharp",
  ...
  },
  {
    ...
    "answer": [
      {
        "type": "text",
        "content": "1. Column order matters: Most selective column first"
      },
      {
        "type": "text",
        "content": "`sql"
      ...
      {
        "type": "text",
        "content": "-- GOOD: UserId is highly selective (filters to one user)"
      },
      {
        "type": "text",
        "content": "CREATE INDEX IX_Orders ON Orders (UserId, Status, CreatedAt);"
      },
      {
        "type": "text",
      ...
      {
        "type": "text",
        "content": "2. Include frequently selected columns to avoid lookups"
      },
      {
        "type": "text",
        "content": "3. Don't over-index: Every index slows writes (INSERT/UPDATE/DELETE)"
      },
      {
        "type": "text",
        "content": "4. Monitor index usage:"
      },
      {
        "type": "text",
        "content": "`sql"
      ...
      {
        "type": "text",
        "content": "OBJECT_NAME(i.object_id) AS TableName,"
      },
      {
        "type": "text",
        "content": "i.name AS IndexName,"
      },
      {
        "type": "text",
        "content": "s.user_seeks,"
      },
      {
        "type": "text",
        "content": "s.user_scans,"
      },
      {
        "type": "text",
        "content": "s.user_updates"
      },
      {
        "type": "text",
        "content": "FROM sys.indexes i"
      },
      {
        "type": "text",
        "content": "LEFT JOIN sys.dm_db_index_usage_stats s"
      },
      {
        "type": "text",
        "content": "ON i.object_id = s.object_id AND i.index_id = s.index_id"
      },
      {
        "type": "text",
        "content": "WHERE s.user_seeks = 0"
      },
      {
        "type": "text",
        "content": "AND s.user_scans = 0"
      },
      {
        "type": "text",
        "content": "AND s.user_updates > 0; -- Written to but never read"
      },
      {
        "type": "text",
        "content": "`"
  ...
  },
  {
    ...
    "answer": [
      ...
      {
        "type": "text",
        "content": "1. a = a ^ b → combined info of a & b"
      },
      {
        "type": "text",
        "content": "2. b = a ^ b → becomes original a"
      },
      {
        "type": "text",
        "content": "3. a = a ^ b → becomes original b"
      }
    ],
    "category": "practice",
    "topic": "real exam questions answers",
